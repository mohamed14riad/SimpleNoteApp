...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        // query.
        String query = "CREATE TABLE "+TABLE_NOTE+"("+COLUMN_NOTE_ID+" INTEGER PRIMARY KEY AUTOINCREMENT,"
                        +COLUMN_NOTE_TITLE+" TEXT NOT NULL,"+COLUMN_NOTE_CONTENT+" TEXT NOT NULL)";
